...
local AutomaticConvolution2DBlock = {}

AutomaticConvolution2DBlock.__index = AutomaticConvolution2DBlock

setmetatable(AutomaticConvolution2DBlock, BaseConvolutionBlock)
...
function AutomaticConvolution2DBlock.new(parameterDictionary)

	parameterDictionary = parameterDictionary or {}

	local NewAutomaticConvolution2DBlock = BaseConvolutionBlock.new(parameterDictionary)

	setmetatable(NewAutomaticConvolution2DBlock, AutomaticConvolution2DBlock)

	NewAutomaticConvolution2DBlock:setName("AutomaticConvolution2D")
	...
	NewAutomaticConvolution2DBlock.numberOfKernels = numberOfKernels

	NewAutomaticConvolution2DBlock.kernelDimensionSizeArray = kernelDimensionSizeArray

	NewAutomaticConvolution2DBlock.strideDimensionSizeArray = strideDimensionSizeArray

	NewAutomaticConvolution2DBlock:setFunction(function(inputTensorArray)
		...
		local kernelDimensionSizeArray = NewAutomaticConvolution2DBlock.kernelDimensionSizeArray 

		local transformedTensorDimensionSizeArray = {inputTensorDimensionSizeArray[1], NewAutomaticConvolution2DBlock.numberOfKernels}
		...
		local weight4DTensor = NewAutomaticConvolution2DBlock:getWeightTensor(true)

		local dimensionSizeArray = NewAutomaticConvolution2DBlock.dimensionSizeArray

		if (not weight4DTensor) then

			dimensionSizeArray = {NewAutomaticConvolution2DBlock.numberOfKernels, inputTensorDimensionSizeArray[2], kernelDimensionSizeArray[1], kernelDimensionSizeArray[2]}

			NewAutomaticConvolution2DBlock.dimensionSizeArray = dimensionSizeArray

			weight4DTensor = NewAutomaticConvolution2DBlock:generateWeightTensor(dimensionSizeArray)

			NewAutomaticConvolution2DBlock:setWeightTensor(weight4DTensor, true)

		elseif (not dimensionSizeArray) then

			dimensionSizeArray = AqwamTensorLibrary:getDimensionSizeArray(weight4DTensor)
	...
	NewAutomaticConvolution2DBlock:setChainRuleFirstDerivativeFunction(function(initialPartialFirstDerivativeTensor, transformedTensor, inputTensorArray)

		local transformedTensorDimensionSizeArray = AqwamTensorLibrary:getDimensionSizeArray(transformedTensor)

		local kernelDimensionSizeArray = NewAutomaticConvolution2DBlock.kernelDimensionSizeArray

		local strideDimensionSizeArray = NewAutomaticConvolution2DBlock.strideDimensionSizeArray
	...
	NewAutomaticConvolution2DBlock:setFirstDerivativeFunction(function(initialPartialFirstDerivativeTensor, transformedTensor, inputTensorArray)  
	...
	return NewAutomaticConvolution2DBlock

end

return AutomaticConvolution2DBlock
