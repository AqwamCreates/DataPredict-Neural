...
setmetatable(DeepNStepQLearningModel, ReinforcementLearningBaseModel)
...
function DeepNStepQLearningModel.new(parameterDictionary)
	...
	local NewDeepNStepQLearningModel = ReinforcementLearningBaseModel.new(parameterDictionary)
	...
	NewDeepNStepQLearningModel:setCategoricalUpdateFunction(function(previousFeatureTensor, previousAction, rewardValue, currentFeatureTensor, currentAction, terminalStateValue)
