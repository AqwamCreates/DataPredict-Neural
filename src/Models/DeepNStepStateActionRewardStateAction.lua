...
setmetatable(DeepNStepStateActionRewardStateActionModel, ReinforcementLearningBaseModel)
...
function DeepNStepStateActionRewardStateActionModel.new(parameterDictionary)
	...
	local NewDeepNStepStateActionRewardStateActionModel = ReinforcementLearningBaseModel.new(parameterDictionary)
	...
	NewDeepNStepStateActionRewardStateActionModel:setCategoricalUpdateFunction(function(previousFeatureTensor, previousAction, rewardValue, currentFeatureTensor, currentAction, terminalStateValue)
		...
		local currentQTensor = Model:predict(currentFeatureTensor, true)
