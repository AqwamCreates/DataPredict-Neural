...
function ProximalPolicyOptimizationModel.new(parameterDictionary)
	...
	NewProximalPolicyOptimizationModel:setEpisodeUpdateFunction(function(terminalStateValue)
		...
		for h, featureTensor in ipairs(featureTensorHistory) do
			...
			criticHiddenStateValue = CriticModel:forwardPropagate(featureTensor, criticHiddenStateValue)
...
return ProximalPolicyOptimizationModelsetmetatable(ProximalPolicyOptimizationModel, DeepReinforcementLearningActorCriticBaseModel)
