...
local AveragePooling3DBlock = {}

AveragePooling3DBlock.__index = AveragePooling3DBlock

setmetatable(AveragePooling3DBlock, BasePoolingBlock)

local defaultKernelDimensionSizeArray = {2, 2, 2}

local defaultStrideDimensionSizeArray = {1, 1, 1}

function AveragePooling3DBlock.new(parameterDictionary)

	parameterDictionary = parameterDictionary or {}

	local NewAveragePooling3DBlock = BasePoolingBlock.new()

	setmetatable(NewAveragePooling3DBlock, AveragePooling3DBlock)

	NewAveragePooling3DBlock:setName("AveragePooling3D")
	...
	NewAveragePooling3DBlock.kernelDimensionSizeArray = kernelDimensionSizeArray

	NewAveragePooling3DBlock.strideDimensionSizeArray = strideDimensionSizeArray

	NewAveragePooling3DBlock:setFunction(function(inputTensorArray)
		...
		local kernelDimensionSizeArray = NewAveragePooling3DBlock.kernelDimensionSizeArray 

		local strideDimensionSizeArray = NewAveragePooling3DBlock.strideDimensionSizeArray
				...
				for c = 1, transformedTensorDimensionSizeArray[3], 1 do
					...
					for d = 1, transformedTensorDimensionSizeArray[4], 1 do
						...
						for e = 1, transformedTensorDimensionSizeArray[5], 1 do
							...
							transformedTensor[a][b][c][d][e] = averageValue
	...
	NewAveragePooling3DBlock:setChainRuleFirstDerivativeFunction(function(initialPartialFirstDerivativeTensor, transformedTensor, inputTensorArray)
		...
		local kernelVolume = kernelDimensionSizeArray[3] * kernelDimensionSizeArray[4] * kernelDimensionSizeArray[5]
							...
							for x = originDimensionIndexArray[1], targetDimensionIndexArray[1], 1 do
								...
								for y = originDimensionIndexArray[2], targetDimensionIndexArray[2], 1 do
									...
									for z = originDimensionIndexArray[3], targetDimensionIndexArray[3], 1 do
										...
										chainRuleFirstDerivativeTensor[a][b][x][y][z] = chainRuleFirstDerivativeTensor[a][b][x][y][z] + initialPartialFirstDerivativeValue
	...
	return NewAveragePooling3DBlock

end

return AveragePooling3DBlock
