...
function ClipValueGradientClipper.new(parameterDictionary)
	...
	NewClipValueGradientClipper:setClipFunction(function(costFunctionDerivativeTensor)
		...
		return AqwamTensorLibrary:applyFunction(functionToApply, costFunctionDerivativeTensor)
